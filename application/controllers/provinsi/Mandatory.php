...
class Mandatory extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->akses['akses'] == 'Y') {
            ...
            $this->load->view('provinsi/mandatory/view', $data);
        } else {
        ...
        if ($this->akses['akses'] == 'Y') {
            ...
            foreach ($result as $r) {
                ...
                $row = [
                    ...
                    'pendidikan' => "Rp. ".format_rupiah($row_mandatory['pendidikan'])."<br>".$row_mandatory['persen_pendidikan']." %",
                    'kesehatan' => "Rp. ".format_rupiah($row_mandatory['kesehatan'])."<br>".$row_mandatory['persen_kesehatan']." %",
                    'infrastruktur' => "Rp. ".format_rupiah($row_mandatory['infrastruktur'])."<br>".$row_mandatory['persen_infrestruktur']." %",
                    'pengawasan' => "Rp. ".format_rupiah($row_mandatory['pengawasan'])."<br>".$row_mandatory['persen_pengawasan']." %"
                ];
                $data[] = $row;
            }
            $output['data'] = $data;
    ...
    public function detail($tahun, $encrypt_id)
    {
        ...
        $this->load->view('provinsi/mandatory/view_detail', $data);
    }
    ...
    public function form()
    {
        ...
        if ($opsi == "add") {
            ...
            $this->load->view('provinsi/mandatory/form_add', $data);
        } elseif ($opsi == "edit") {
            ...
            $this->load->view('provinsi/mandatory/form_edit', $data);
        } else {
