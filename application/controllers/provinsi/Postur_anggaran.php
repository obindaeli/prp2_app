...
class Postur_anggaran extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->akses['akses'] == 'Y') {
            ...
            $this->load->view('provinsi/postur_anggaran/view', $data);
        } else {
