        ...
        <div class="container d-flex align-items-center">
            <div class="form-holder">
                <div class="row has-shadow">
                    <div class="col-lg-6">
                        <div class="info d-flex align-items-center">
                            <div class="content">
                                <h2 class="text-center mb-3" style="font-size: 1em;">Progress Report Pengendalian Pembangunan Nias Barat</h2>
                                <div class="logo" style="text-align: center;">
                                    <img src="<?= base_url('images/logo_niasbarat.png'); ?>" class="img-fluid img-logo" width="175px">
                                </div>
                                <br>
                                <h2 class="text-center" style="font-size: 1em; font-weight: bold;">Kabupaten Nias Barat</h2>
                            </div>
                        </div>
                    </div>
                ...
                <div class="text-center" style="color: white; margin-top: 15px;">
                    <strong>Copyright &copy; <?= "2022"; ?> DINAS KOMUNIKASI DAN INFORMATIKA NIAS BARAT</strong>
                </div>
            </div>
        </div>
    </div>
