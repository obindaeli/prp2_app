...
<div class="panel-header bg-primary-gradient">
    <div class="page-inner py-4">
        <div class="d-flex align-items-left flex-column flex-sm-row">
            <h3 class="text-white pb-3 fw-bold">Data Anggaran SKPD Pada APBD Provinsi Sumatera Utara</h3>
        </div>
    </div>
</div>
                            ...
                            <table id="load-content" class="table-default" style="width: 100%;">
                                <thead>
                                    <tr style="background-color: #1572EB; color: white;">
                                        <th width="5px">NO</th>
                                        <th>NAMA OPD</th>
                                        <th class="text-center">PENDAPATAN DAERAH</th>
                                        <th class="text-center">BELANJA DAERAH</th>
                                        <th class="text-center">JML URAIAN</th>
                                    </tr>
                                </thead>
                                <tbody></tbody>
                            </table>
...
<?php $this->load->view('upload_anggaran/skpd/js'); ?>
