...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="<?= base_url('images/logo_niasbarat.png')?>">
                ...
                <div class="container clearfix">
                    ...
                    <div class="main-navigation">
                        <ul class="one-page-scroll-menu navigation-box">
                            ...
                            <li class="scrollToLink">
                                <a href="http://niasbaratkab.go.id/">Website</a>
                            </li>
                            <li class="scrollToLink">
                                <a href="<?= base_url('apbd-2022')?>">APBD</a>
                            </li>
                            <li class="scrollToLink">
                                <a href="<?= base_url('kegiatan-fisik-2022')?>">Kegiatan Fisik</a>
                            </li>
                        </ul>
                    </div><!-- /.navbar-collapse -->
        ...
        <section class="banner-one" id="banner">
            ...
            <div class="container">
                <div class="banner-one__moc">
                    <img src="<?= base_url('assets/assets/images/mocs/niasbarat.png')?>" alt="Awesome Image" />
                </div><!-- /.banner-one__moc -->
                <div class="row">
                    <div class="col-xl-6 col-lg-8">
                        <div class="banner-one__content">
                            <h3 class="banner-one__title"><span>SIM</span> <br>PRP2NISBAR</h3><!-- /.banner-one__title -->
                            <br>
                            <h4>Progress Report Pengendalian Pembangunan Nias Barat</h4><!-- /.banner-one__title -->
                            <p class="banner-one__text">Bagian Administrasi Pembangunan Setda Kabupaten Nias Barat</p>
                            <!-- /.banner-one__text -->
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-duration="1500ms">
                        <div class="service-one__single text-center">
                            <div class="service-one__inner">
                                ...
                                <p>Sistem Informasi Monitoring Evaluasi Pelaporan Online</p>
                                <a href="<?= base_url('apbd-2022')?>" class="service-one__link"> APBD <i class="dimon-icon-right-arrow"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 wow fadeInDown" data-wow-duration="1500ms">
                        <div class="service-one__single text-center">
                            <div class="service-one__inner">
                                <i class="service-one__icon  fa fa-line-chart"></i>
                                <p>Sistem Informasi Monitoring Evaluasi Pelaporan Online</p>
                                <a href="<?= base_url('kegiatan-fisik-2022')?>" class="service-one__link"> Kegiatan Fisik <i class="dimon-icon-right-arrow"></i></a>
            ...
            <div class="site-footer__bottom">
                <div class="container">
                    <div class="inner-container text-center">
                        <p class="site-footer__copy">&copy; copyright 2022 by <a href="#">DINAS KOMUNIKASI DAN INFORMATIKA NIAS BARAT</a></p>
                        <!-- /.site-footer__copy -->
                    </div><!-- /.inner-container -->
                </div><!-- /.container -->
