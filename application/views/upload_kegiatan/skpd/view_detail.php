...
<div class="panel-header bg-primary-gradient">
    <div class="page-inner py-4">
        <div class="d-flex align-items-left flex-column flex-sm-row">
            <h3 class="text-white pb-3 fw-bold">Data Kegiatan <?= $skpd['nama_skpd'] ?> Pada APBD Provinsi Sumatera Utara Tahun 2021</h3>
        </div>
    </div>
</div>
...
<?php $this->load->view('upload_kegiatan/skpd/js_detail'); ?>
