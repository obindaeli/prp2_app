...
<head>
    ...
    <meta name="description" content="Progress Report Pengendalian Pembangunan Kabupaten Nias Barat" />
    <meta name="keywords" content="aplikasi,Kabupaten, Nias Barat,pengendalian,pembangunan,report" />
    <meta name="author" content="Progress Report Pengendalian Pembangunan Kabupaten Nias Barat" />
...
<body onload='window.print()' onfocus='window.close()'>
    <div class='box-header'>
        <div class='alignleft'>
            <img src='<?= base_url('images/logo_naisbarat.png'); ?>' width='50px'>
        </div>
        <div class='aligncenter'>
            <span class='title'>PEMERINTAH KABUPATEN NIAS BARAT</span>
    ...
    <div class='box-body'>
        <table style="width: 100%;">
            ...
            <?php
                ...
                $cek_tanggal_data = $this->mquery->select_id('log_upload', ['id_skpd' => $skpd['id_skpd'], 'tahun'=> $tahun, 'bulan'=> $bulan]);
                $tanggal_data=$cek_tanggal_data['tgl_data'];

                if($tanggal_data<$tgl_papbd){$hsl_stanggaran=1;}
                else{$hsl_stanggaran=2;}

                $cek_tanggal_data_1 = $this->mquery->select_id('log_upload', ['id_skpd' => $skpd['id_skpd'], 'tahun'=> $tahun, 'bulan'=> $bulan_1]);
    ...
    <div class='aligntandatangan'>
        LAHOMI, <?=nama_bulan($tanggal_input)?>
