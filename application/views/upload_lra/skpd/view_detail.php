            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <h3 class="pb-3 fw-bold"><?= $skpd['nama_skpd'] ?></h3>
                        ...
                        <a href="<?= base_url('uploads/format/Format_Laporan_Realisasi_Anggaran_(LRA)_PRP2SUMUT.xls') ?>" target="_blank" class="btn btn-success btn-round btn-sm mr-2 mb-3"><i class="fa fa-download"></i> Format Excel</a>
                            ...
                            <table id="load-content" class="table-default" style="width: 100%;">
                                <thead>
                                    <tr style="background-color: #1572EB; color: white;">
                                        ...
                                        <th class="text-center">Serapan OPD</th>
...
<?php $this->load->view('upload_lra/skpd/js_detail'); ?>
